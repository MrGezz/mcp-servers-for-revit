    ...
    public partial class CommandSetSettingsPage : Page
    {
                ...
                foreach (var directory in commandSetDirectories)
                {
                    ...
                    if (File.Exists(commandJsonPath))
                    {
                        ...
                        if (commandSetData != null)
                        {
                            ...
                            // Detect supported Revit versions from year-named subfolders
                            ...
                            {
                                // Create a command config; determine supported versions by inspecting subfolders
                            ...
                            // If there are available commands, add this command set to the list
        ...
        private void SaveButton_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                {
                    // Try to retrieve developer info from command.json
                    ...
                    foreach (var command in commandSet.Commands)
                    {
                        ...
                        if (command.Enabled)
                        {
                            ...
                            // Check whether this command already exists in the registry
                            ...
                            {
                                // If this is a new command, create a new config
