...
{
    public class CreateViewTemplateEventHandler : WaitableEventHandlerBase, IExternalEventHandler, IWaitableExternalEventHandler
    {
        ...
        public void Execute(UIApplication uiapp)
        {
            ...
            try
            {
                using (Transaction trans = new Transaction(doc, "Create View Template"))
                {
                    ...
                    View sourceView = doc.GetElement(ElementIdFactory.Create(SourceViewId)) as View;
                    if (sourceView == null)
                    {
