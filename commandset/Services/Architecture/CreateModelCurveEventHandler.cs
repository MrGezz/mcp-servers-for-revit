...
{
    public class CreateModelCurveEventHandler : WaitableEventHandlerBase, IExternalEventHandler, IWaitableExternalEventHandler
    {
                ...
                foreach (var info in CurveData)
                {
                    using (Transaction tx = new Transaction(_doc, "Create Model Curve"))
                    {
                        ...
                        try
                        {
                            ...
                            {
                                sketchPlane = _doc.GetElement(ElementIdFactory.Create(info.SketchPlaneId)) as SketchPlane;
                            }
